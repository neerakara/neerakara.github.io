---
title: "Machine Learning Optimization Basics: Gradients, Jacobians, Hessians"
date: 2026-03-13
description: "An introduction to optimization in machine learning: gradients, Jacobians, Hessians, backpropagation and Adam."
---
...
In this post, we review the basic mathematical objects behind these algorithms: gradients, Jacobians and Hessians.
...
::: {.callout-note collapse="true" title="2. Gradients, Jacobians and Hessians"}
...
::: {.callout-note collapse="true" title="3. Backpropagation as a Vector–Jacobian Product"}
...
::: {.callout-note collapse="true" title="4. Hessian approximations in practice"}
...
::: {.callout-note collapse="true" title="Appendix A: Newton's method from a Taylor expansion" #appendix-a}
...
::: {.callout-note collapse="true" title="Appendix B: Diagonal Hessian Approximation" #appendix-b}
